...
4. Updates the alias_index_health and alias_rollover_attempt_health for each Alias using the AliasStatus objects.
5. Waits a minute
...
7. Outputs the difference as the Prometheus alias_rate and alias_index_operation_failures metrics.
